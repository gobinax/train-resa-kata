...
public class TicketOfficeTest {
    ...
    public void should_call_reservation_if_seats_available() {
        ...
        // when
        Reservation reservation = new TicketOffice(bookingReferences, trainDataGateway)
    ...
    public void should_NOT_call_reservation_if_no_seats_available() {
        ...
        // when
        Reservation reservation = new TicketOffice(mock(BookingReferences.class), trainDataGateway)
                .makeReservation(new ReservationRequest(trainId, 2));
